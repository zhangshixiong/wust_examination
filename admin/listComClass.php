<?php
    ...
    $pageSize = 7;
    $pid = isset($_GET['c_pid']) ? $_GET['c_pid'] : 0;
    $rows = getAllComClassByPage($page,$pageSize,$pid);
    if(!$rows){
        ...
        <table class="table" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo "<a href='listComClass.php?c_pid=".$row['c_id']."'>".$row['c_name']."</a>" ?></td>
                ...
                <?php endforeach;?> 
                <?php if($totalRows1>$pageSize):?>             
                <tr>
                    <td colspan="5"><?php $where="c_pid=".$row['c_pid']; echo showPage($page,$totalPage1,$where); ?></td>
                </tr>
                <?php endif;?>
            </tbody>
        </table>
